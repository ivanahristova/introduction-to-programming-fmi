...
int main() 
{
    ...
    */
    ...
    int output6 = (a -= 1); // 67
    /*
    Изразът (а -= 1) е еквивалентен запис на (а = а - 1). Ние променяме стойността на а и
    тя става а = 68 - 1, тоест вече а = 67. Операторът за присвояване е дясноасоциативен, 
    значи променя стойността и връща като нова стойност левия си операнд.
    */

...
int main()
{
	...
	cout << a << " " << (a << 1) << endl; // 0010 => 0100 (При << всички символи се изместват наляво с дадения брой позиции) 
	a <<= 1; // еквивалентно на: а = а << 1;
	cout << a << " " << (a << 1) << endl; // 0100 => 1000
	cout << a << " " << (a >> 2) << endl; // 0100 => 0001 (При >> всички символи се изместват надясно с дадения брой позиции)
	b = 5;
